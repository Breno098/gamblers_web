@extends('adm.layout', ['title' => $games->count() > 0 ? "{$games->count()} jogos" : 'Não há jogos no momento.'])
...
@section('content')
    <div class="mdl-grid" style="display: flex; justify-content: center">
                ...
                <div class="mdl-card__title" style="display: flex; flex-direction: row; justify-content: space-between">
                    <div class="mdl-cell mdl-cell--12-col mdl-card">
                        <div class="mdl-card__title" style="display: flex; justify-content: center">
                            <h1 class="mdl-card__title-text">
                                <strong> {{ $game->date->format('d/m/Y') }} | {{ $game->date->format("H:i") }} </strong>
                            </h1>
                        </div>
        ...
        @empty
            <div class="mdl-cell mdl-cell--8-col mdl-card mdl-shadow--16dp">
                <div class="mdl-card__title" style="display: flex; flex-direction: row; justify-content: center">
                    <h1 class="mdl-card__title-text" style="display: flex; align-items: center">
                        <strong style="text-align: center"> Não há jogos para esse competição no momento. </strong>
                    </h1>
                </div>
                <div style="height: 600px; background: url('{{ asset('storage/app/default_competition.jpg') }}') center / cover;"/>
            </div>
        @endforelse
