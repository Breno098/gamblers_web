                    ...
                    <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp" aria-label="Países" style="width: 100%">
                        ...
                        <tbody class="mdc-data-table__content">
                            ...
                            <tr class="mdc-data-table__row">
                                <td class="mdl-data-table__cell--non-numeric" style="width: 10%">{{ $team->id }}</td>
                                <td class="mdl-data-table__cell--non-numeric" style="width: 40%">{{ $team->name }}</td>
                                <td class="mdl-data-table__cell--non-numeric" style="width: 40%">{{ $team->country->name }}</td>
